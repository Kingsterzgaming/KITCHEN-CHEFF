...
//        [Header("Delivered Ingredient Sprites")]
//        [SerializeField] private Sprite deliveredVegetableSprite;
//        [SerializeField] private Sprite deliveredCheeseSprite;
//        [SerializeField] private Sprite deliveredMeatSprite;
...
//                icon.SetIcon(GetSprite(requiredType));
...
namespace YesChef.UI
{
    public class OrderUI : MonoBehaviour
    {
        ...
        private void UpdateTimer(Order order)
        {
            ...
            timerText.text = $"{order.ElapsedSeconds:00}s";
        }
        ...
        private Sprite GetDeliveredSprite(IngredientType type)
        {
            switch (type)
            {
                case IngredientType.Vegetable:
                    return deliveredVegetableSprite;

                case IngredientType.Cheese:
                    return deliveredCheeseSprite;

                case IngredientType.Meat:
                    return deliveredMeatSprite;
        ...
        private void ClearUI()
        {
            ...
            foreach (IngredientIconUI icon in ingredientIcons)
            {
                if (icon != null)
                    icon.Clear();
            }
